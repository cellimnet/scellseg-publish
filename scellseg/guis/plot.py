...
from scellseg import utils
from scellseg.guis import iopart
...
def show_segmentation(fig, img, maski, flowi, channels=[0,0], file_name=None):
    ...
    if file_name is not None:
        ...
        iopart.imsave(save_path + '_overlay.jpg', overlay)
        iopart.imsave(save_path + '_outlines.jpg', imgout)
        iopart.imsave(save_path + '_flows.jpg', flowi)
