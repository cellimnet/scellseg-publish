...
class Ui_MainWindow(QtGui.QMainWindow):
    ...
    def setupUi(self, MainWindow,image=None):
        ...
        self.eraser_combobox.addItems(["Delete[Shift+Right]","Pixal add[Right]"])
    ...
    def compute_model(self):
        ...
        if True:
            ...
            self.state_label.setText('%d cells found with scellseg net in %0.3f sec' % (len(np.unique(masks)[1:]), time.time() - tic), color='#008000')
